...
void Controladora::dibujarventana()
{
	...
	dibujarBase();
    dibujarMatriz();
	VentanaInicial->draw(chefcito->getspritechef());
...
void Controladora::eventosventana()
{
	while (VentanaInicial->pollEvent(*eventoventana))
	{
		switch (eventoventana->type)
		{
		case Event::Closed:
		...
		case Event::KeyPressed:
			...
			{
				chefcito->setpositionup();
			}
			else if (Keyboard::isKeyPressed(Keyboard::Down))
			{
				chefcito->setpositiondown();
			}
			else if (Keyboard::isKeyPressed(Keyboard::Left))
			{
				chefcito->setpositionleft();
			}
			else if (Keyboard::isKeyPressed(Keyboard::Right))
			{
				chefcito->setpositionright();
			}
